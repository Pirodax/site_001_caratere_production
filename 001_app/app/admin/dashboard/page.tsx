          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-white">Médias</h3>
                  <p className="text-sm text-white/60">Bibliothèque médias</p>
                </div>
              </div>
              <p className="text-2xl font-bold text-white">0</p>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/60">Configuration du site</p>
                </div>
              </div>
            </motion.div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white font-medium">Éditeur Simple</span>
                </div>
              </motion.button>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white font-medium">Ajouter un film</span>
                </div>
              </motion.button>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white font-medium">Upload média</span>
                </div>
              </motion.button>
            </div>
          </div>
