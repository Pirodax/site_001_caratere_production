          ...
          <div className="mt-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <motion.button
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                onClick={() => window.open(process.env.NEXT_PUBLIC_UMAMI_SHARE_URL, '_blank')}
                className="p-4 bg-white/5 text-white border border-white/10 rounded-lg hover:bg-white/10 transition-all text-left"
              >
                <div className="flex items-center gap-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
